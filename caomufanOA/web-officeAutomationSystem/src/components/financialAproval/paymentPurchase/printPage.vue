<template>
    <div class="printPage">
      ...
      <table width="100%" border="1" cellspacing="0" cellpadding="0" >
        ...
        <tr>
          <td class="iteamName">支付类型</td>
          <td>
            <span v-if="printList.payType==0" value="0">按合同支付</span>
            <span v-if="printList.payType==1" value="1">无合同支付</span>
          </td>
        ...
        <tr>
          <td class="iteamName">合同金额</td>
          <td>{{printList.contractPrice}}</td>
          <td class="iteamName">累计已支付</td>
          <td>{{printList.cumulativePaid}}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <span v-if="printList.payment==0" value="0">总公司</span>
            <span v-if="printList.payment==1" value="1">东莞分公司</span>
            <span v-if="printList.payment==2" value="1">韶关分公司</span>
          </td>
        </tr>
      </table>
      <table style="border-top: 0" width="100%" border="1" cellspacing="0" cellpadding="0" >
        ...
        <tr v-for="(item,index) in printList.purchaseDetailList">
          <td >{{item.abstract}}</td>
          <td>{{item.price}}</td>
          <td >
