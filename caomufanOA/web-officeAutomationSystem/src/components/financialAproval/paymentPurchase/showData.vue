<template>
    <div class="componentsfinancialAprovalpaymentPurchaseshowData">
     <!--    表单填取部分-->
        ...
        <el-form label-position="right" size="medium" :model="showData"  ref="ruleForm" label-width="120px" class="formBody">
          ...
          <div class="formItem">
            <el-form-item label="支付类型：" prop="name">
              <span v-if="showData.payType==0" value="0">按合同支付</span>
              <span v-if="showData.payType==1" value="1">无合同支付</span>
            </el-form-item>
          </div>
          <div class="formItem">
          ...
          <div class="formItem">
            <el-form-item label="合同金额：" prop="name">
              <span>{{showData.contractPrice}}</span>
            </el-form-item>
          </div>
          <div class="formItem">
            <el-form-item label="累计已支付：" prop="name">
              <span>{{showData.cumulativePaid}}</span>
            </el-form-item>
          </div>
          <div class="formItem">
          ...
          <div class="detailContent">
              ...
              <div class="detailItem">
                <table width="98%" border="1" cellspacing="0" cellpadding="0" >
                  ...
                  <template v-for="(item,index) in showData.purchaseDetailList">
                  <tr>
...
<script>
    ...
    import printPage from "@/components/financialAproval/paymentPurchase/printPage";
...
<style lang="scss">
  .componentsfinancialAprovalpaymentPurchaseshowData{
    .formSelect{
      width: 400px;
    }
