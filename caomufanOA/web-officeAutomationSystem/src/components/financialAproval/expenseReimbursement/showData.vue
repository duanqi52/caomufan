<template>
    <div class="componentsfinancialAprovalexpenseReimbursementshowData">
     <!--    表单填取部分-->
      <div class="formContent">
        <el-form label-position="right" size="medium" :model="showData"  ref="showData" label-width="120px" class="formBody">
          <div class="formItem">
          ...
          <div class="formItem">
            <el-form-item label="费用报销类型：" prop="name">
              <span v-if="showData.reimbursementType==1"  value="1">日常费用报销</span>
              <span v-if="showData.reimbursementType==2"  value="2">项目费用报销</span>
              <span v-if="showData.reimbursementType==3"  value="3">团队活动费用报销</span>
            </el-form-item>
          </div>
          <div class="formItem">
          ...
          <div class="detailContent">
              ...
              <div class="detailItem">
                <table width="98%" border="1" cellspacing="0" cellpadding="0" >
                  ...
                  <template v-for="(item,index) in showData.reimbursementDetailList">
                  <tr>
        ...
        <div class="remarksBox">
          <div class="remakeMoney">
            <div class="remakeMoneyItem">
              <div class="remakeMoneyName">
                <span>小写合计金额：</span>
              </div>
              <div class="remakeMoneyShow" v-if="showData.totalPay>999">
                {{showData.totalPay.toLocaleString('en-US')}} 元
              </div>
              <div class="remakeMoneyShow" v-else>
                {{showData.totalPay}} 元
              </div>
            </div>
            <div class="remakeMoneyItem">
            ...
            <div class="remakeMoneyItem">
              ...
              <div class="remakeMoneyShow">
                {{showData.originalBorrow}} 元
              </div>
            </div>
            <div class="remakeMoneyItem">
              <div class="remakeMoneyName">
                <span  v-if="showData.isRefund">应退差额：</span>
                <span v-else>应补差额：</span>
              </div>
              <div class="remakeMoneyShow">
...
<!--                {{showData.blance}} 元-->
      ...
      >
        <div id="printTest">
          <printPage :printData="showData"></printPage>
        </div>
      </div>
...
<script>
    ...
    import printPage from "@/components/financialAproval/expenseReimbursement/printPage";
...
<style lang="scss">
  .componentsfinancialAprovalexpenseReimbursementshowData{
    .formSelect{
      width: 400px;
    }
