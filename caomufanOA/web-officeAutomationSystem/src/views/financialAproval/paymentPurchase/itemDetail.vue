<template>
  <div  class="contentBody financialAprovalPaymentPurchaseItemDetail">
    <!--                  顶部按钮部分-->
    <div class="companyTitle">
      <div class="companyName">支付申请单--详情</div>
      <div class="companyBtnBox">
        <div class="companyBtn">
          ...
          <template v-if="showEditStatus==false">
            ...
            <router-link  class="btn_left" :to="{path:'/financialAproval/paymentPurchase'}">
...
<script>
    ...
    import showData from "@/components/financialAproval/paymentPurchase/showData";
    ...
    import addOreditShow from "@/components/financialAproval/paymentPurchase/addOreditShow";
    export default {
        name: "itemDetail",
...
<style lang="scss">
  .financialAprovalPaymentPurchaseItemDetail{
    .formSelect{
      width: 400px;
    }
