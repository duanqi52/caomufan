<template>
  <div  class="contentBody viewsfinancialAprovaltravelExpensesitemDetail">
    <!--                  顶部按钮部分-->
    <div class="companyTitle">
      <div class="companyName">差旅费审批单--详情</div>
      <div class="companyBtnBox">
        <div class="companyBtn">
          ...
          <template v-if="showEditStatus==false">
            ...
            <router-link   class="btn_left"  :to="{path:'/financialAproval/travelExpenses'}">
...
<script>
    ...
    import showData from "@/components/financialAproval/travelExpenses/showData";
    import addOreditShow from "@/components/financialAproval/travelExpenses/addOreditShow";
    export default {
        name: "itemDetail",
        data(){
            return{
...
<style lang="scss">
  .viewsfinancialAprovaltravelExpensesitemDetail{
    .formSelect{
      width: 400px;
    }
