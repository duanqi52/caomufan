<template>
  <div  class="contentBody viewsfinancialAprovalloanApprovalitemDetail">
    <!--                  顶部按钮部分-->
    <div class="companyTitle">
      <div class="companyName">借款审批单--详情</div>
      <div class="companyBtnBox">
        <div class="companyBtn">
          ...
          <template v-if="showEditStatus==false">
            ...
            <router-link   class="btn_left"  :to="{path:'/financialAproval/loanApproval'}">
...
<script>
    import showData from "@/components/financialAproval/loanApproval/showData";
    ...
    import addOreditShow from "@/components/financialAproval/loanApproval/addOreditShow";
    export default {
        name: "itemDetail",
        data(){
            return{
...
<style lang="scss">
  .viewsfinancialAprovalloanApprovalitemDetail{
    .formSelect{
      width: 400px;
    }
