<template>
  <div class="contentBody">
    ...
    <div class="companyTitle">
      <div class="companyName">借款审批单</div>
      <div class="companyBtnBox">
        <div class="companyBtn">

          <router-link :to="{path:'/financialAproval/loanApproval/addOrEdit'}">
    ...
    <div class="listShowBox">
      <table width="100%">
        <tr class="listTitleBox">
          ...
          <th class="titleItem">项目编号</th>
          <th class="titleItem">项目名称</th>
    ...
    export default {
        ...
        methods:{
            ...
            showPageGoNow(id){
                this.$router.push(
                    {
                        path:'/financialAproval/loanApproval/itemDetail',
                        query:{
                            id:id
                        }
                    }
            ...
            getShowList(){
                ...
                getBorrow(
                    ...
                    if(res.messageType==0)
                    {
                        ...
                        this.showList=res.result.borrowRoughList
...
<style scoped lang="scss" src="@/styles/financialAproval/loanApproval/index.scss">
