  ...
  <div class="contentBody">
    ...
    <div class="lsitBody">
      ...
      <div class="topContent">
        ...
        <div class="topItem">
          <div class="topName">状态</div>
          <div class="topList">
            <el-select v-model="searchParamsData.processType" @change="getShowList" placeholder="请选择">
              <el-option key="5" label="待办" value="0"></el-option>
              <el-option key="6" label="已办" value="1"></el-option>
              <el-option key="7" label="待阅" value="2"></el-option>
              <el-option key="9" label="已阅" value="3"></el-option>
              <el-option key="10" label="我发起的" value="4"></el-option>
              <el-option key="8" label="全部" value="5"></el-option>
<!--              <el-option key="0" label="全部" :value="0"></el-option>-->
<!--              <el-option key="1" label="审批中" :value="1"></el-option>-->
<!--              <el-option key="2" label="已完成" :value="2"></el-option>-->
<!--              <el-option key="3" label="已撤回" :value="3"></el-option>-->
<!--              <el-option key="4" label="审批失败" :value="4"></el-option>-->
<!--              <el-option key="5" label="待办" :value="5"></el-option>-->
<!--              <el-option key="6" label="已办" :value="6"></el-option>-->
<!--              <el-option key="7" label="待阅" :value="7"></el-option>-->
<!--              <el-option key="8" label="已阅" :value="8"></el-option>-->
            </el-select>
          </div>
        </div>
        <div class="topItem">
          ...
          <div class="listShowItem">
            ...
            <div class="showItem title4">
              <router-link
                class="moreData"
                :to="{
                path:'/myProcess/whole/itemDetail',
                query:{
    ...
    export default {
        ...
        methods:{
            ...
            getShowList(){
                ...
                spd.processType=spd.processType.toString()
                // console.log(spd)
                getMyProcess(
                    spd
                ).then(res=>{
