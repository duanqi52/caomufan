<template>
  <div  class="contentBody viewsmyProcessneedReaditemDetail">
    <!--                  顶部按钮部分-->
      ...
      <div class="companyBtnBox">
        <div class="companyBtn">
          ...
          <template v-if="showEditStatus==false">
            ...
            <router-link   class="btn_left"  :to="{path:'/myProcess/needRead'}">
                ...
                this.$confirm('此操作将该申请作废, 是否继续?', '提示', {
                    ...
                    undoInvalid(
                        ...
                        if(res.messageType==0)
                        {
                            ...
                            this.$router.push('/myProcess/needRead')
                        }else{
                ...
                if(that.showType=='1')
                {
                    getPurchaseDetail(
                        ...
                        if(res.messageType===0)
                        {
                            ...
                            this.approvalID=res.result.applicationID
...
<style lang="scss">
  .viewsmyProcessneedReaditemDetail{
    .formSelect{
      width: 400px;
    }
