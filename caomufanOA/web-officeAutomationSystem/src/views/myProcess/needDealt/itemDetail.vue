<template>
  <div  class="contentBody viewsmyProcessneedDealtitemDetail">
    <!--                  顶部按钮部分-->
      ...
      <div class="companyBtnBox">
        <div class="companyBtn">
          ...
          <template v-if="showEditStatus==false">
            ...
            <router-link   class="btn_left"  :to="{path:'/myProcess/needDealt'}">
                ...
                this.$confirm('此操作将该申请作废, 是否继续?', '提示', {
                    ...
                    undoInvalid(
                        ...
                        if(res.messageType==0)
                        {
                            ...
                            this.$router.push('/myProcess/needDealt')
                        }else{
...
<style lang="scss">
  .viewsmyProcessneedDealtitemDetail{
    .formSelect{
      width: 400px;
    }
