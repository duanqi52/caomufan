...
<!--            <div class="showItem title2">-->
<!--              <p v-if="item.status==1" style="color:#4ca824 ">审批中</p>-->
<!--              <p v-if="item.status==2" style="color:#f82e2e ">已完成</p>-->
<!--              <p v-if="item.status==3" style="color:#4ca824 ">已撤回</p>-->
<!--              <p v-if="item.status==4" style="color:#888888 ">审批失败</p>-->
<!--              <p v-if="item.status==5" style="color:#4ca824 ">待办</p>-->
<!--              <p v-if="item.status==6" style="color:#4ca824 ">已办</p>-->
<!--              <p v-if="item.status==7" style="color:#4ca824 ">待阅</p>-->
<!--              <p v-if="item.status==8" style="color:#4ca824 ">已阅</p>-->
<!--            </div>-->
            ...
            <div class="showItem title4">
              <router-link
                class="moreData"
                :to="{
                path:'/myProcess/needDealt/itemDetail',
                query:{
