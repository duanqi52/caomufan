<template>
  <div  class="contentBody viewsmyProcessiStarteditemDetail">
    <!--                  顶部按钮部分-->
      ...
      <div class="companyBtnBox">
        <div class="companyBtn">
          ...
          <template v-if="showEditStatus==false">
            ...
            <a  v-if="handle==0&&checkOpenId==winOpenID&&pageData.status!=4&&pageData.status!=7"
                @click="approveGo(2)"
                style="color: #e23030;"
                class="btn_left"  >
            ...
            <router-link   class="btn_left"  :to="{path:'/myProcess/iStarted'}">
...
<script>
    // import  '@/assets/fontStyle/all/iconfont.css'
                ...
                this.$confirm('此操作将该申请作废, 是否继续?', '提示', {
                    ...
                    undoInvalid(
                        ...
                        if(res.messageType==0)
                        {
                            ...
                            this.$router.push('/myProcess/iStarted')
                        }else{
...
<style lang="scss" >
  .viewsmyProcessiStarteditemDetail{
    .formSelect{
      width: 400px;
    }
