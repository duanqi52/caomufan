<template>
    <div class="showContent">
      <div class="companyTitle">
        <div class="companyName">支付采购流程</div>
            ...
            <div class="listShowItem lsi1 ">
              <div class="listMoneyItem">
                <div class="listMoneyItemBox">
                  支付金额：0 —— <input type="number" oninput="if(value.length>8)value=value.slice(0,8)"  v-model="dataShow.firstRule" placeholder="请输入" />
                </div>
              </div>
        ...
        methods:{
            ...
            updataGo(){
                ...
                updataProcess(ud).then(res=>{
                    if(res.messageType==0)
                    {
                        that.$message.success( '支付采购流程-保存成功');
                    }else{
