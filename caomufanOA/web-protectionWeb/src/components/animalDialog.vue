...
<!--                  页头-->
                  <div class="speciesDataCrumbShow">
                    <el-breadcrumb separator-class="el-icon-arrow-right">
                      ...
                      <el-breadcrumb-item class="speciesDataCrumbItem">
                        <a class="speciesCrumbA" @click="getSpeciesList()">蕉鹃科</a>
                      </el-breadcrumb-item>
                      <el-breadcrumb-item class="speciesDataCrumbItem">
                        <a class="speciesCrumbA" >大蓝蕉鹃</a>
                      </el-breadcrumb-item>
                    </el-breadcrumb>
                  </div>
...
<!--                      左边的图和名展示-->
                      <div class="dataTopLeft">
                        <div class="dataImg">
                          <img src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2545483768,3417802214&fm=26&gp=0.jpg" alt="图片">
                        </div>
                        <div class="dataName">
                          <div class="dataNameName">大蓝蕉鹃</div>
                        ...
                        <div class="typeList">
                          <div class="typeShow">
                            ...
                            <div class="typeDataList">
                              <div class="typeDataItem">蓝蕉鹃目</div>
                              <div class="typeDataItem">蓝蕉鹃科</div>
                              <div class="typeDataItem">蓝蕉鹃属</div>
                            </div>
                          </div>
                          <div class="typeAudio">
                    ...
                    <div class="dataBottonBox">
                      ...
                      <div class="dataListBox">
                        ...
                        <div class="dataListItem">
                          ...
                          <div class="dataItemText">
                            都是走地鸡呀啊啊啊啊啊啊撒发放都是走地鸡呀啊啊啊啊啊啊撒发放都是走地鸡呀啊啊啊啊啊啊撒发放
                          </div>
                        </div>
                        <div class="dataListItem">
                          <div class="dataItemTitle">
              ...
              familyList:[
                  {
                      ...
                      children:[
                          {
                              name:'大蓝蕉鹃',
                              img:'https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2545483768,3417802214&fm=26&gp=0.jpg'
                          },
                          {
                              name:'大蓝蕉鹃',
                              img:'https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2545483768,3417802214&fm=26&gp=0.jpg'
